...
import { createDefaultForm, parseSellingPoints, serializeSellingPoints } from './editor-model'

test('new product forms default to non-food', () => {
  assert.equal(createDefaultForm().foodDisclosure.complianceType, 'NON_FOOD')
})
