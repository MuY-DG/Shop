...
- `shopping-cart-brand.svg`：[Iconify Material Symbols `material-symbols:shopping-cart-outline`](https://icon-sets.iconify.design/material-symbols/shopping-cart-outline/)，Apache 2.0，品牌红版本，用于浅色背景上的购物车入口。
...
- `search-material-symbols-iconify.svg`、`tune-outline-rounded.svg`、`verified-user-outline-rounded.svg`：[Iconify Material Symbols](https://icon-sets.iconify.design/material-symbols/)，Apache 2.0，用于搜索、筛选和保障信息。
...
- `profile-location.svg`：项目既有的地址入口 SVG；原始来源未单独记录。
