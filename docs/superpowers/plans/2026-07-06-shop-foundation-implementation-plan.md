...
Shop/
  ...
  backend/
    shop-server/
      ...
      mvnw, mvnw.cmd, .mvn/             Maven wrapper from Spring Initializr.
      src/main/java/com/muybaby/shop/
      ...
      src/main/resources/
        ...
        application-dev.yml             Dev datasource and Redis sample config.
        db/migration/V1__init_foundation.sql
      src/test/java/com/muybaby/shop/
...
- Create: `backend/shop-server/pom.xml`
- Create: `backend/shop-server/mvnw`
- Create: `backend/shop-server/mvnw.cmd`
- Create: `backend/shop-server/.mvn/wrapper/*`
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/ShopServerApplication.java`
- Create: `backend/shop-server/src/main/resources/application.yml`
- Create: `backend/shop-server/src/main/resources/application-dev.yml`
- Create: `backend/shop-server/src/test/java/com/muybaby/shop/ShopServerApplicationTests.java`

- [ ] **Step 1: Generate Spring Boot project with Maven wrapper**

Run:

```bash
mkdir -p /tmp/shop-foundation
curl -fsSL "https://start.spring.io/starter.zip?type=maven-project&language=java&bootVersion=3.5.16&baseDir=shop-server&groupId=com.muybaby.shop&artifactId=shop-server&name=shop-server&description=Hotpot%20Shop%20backend&packageName=com.muybaby.shop&packaging=jar&javaVersion=21&dependencies=web,security,validation,actuator,flyway,mysql" -o /tmp/shop-foundation/shop-server.zip
unzip -q /tmp/shop-foundation/shop-server.zip -d /tmp/shop-foundation
rsync -a /tmp/shop-foundation/shop-server/ backend/shop-server/
...
Modify `backend/shop-server/pom.xml`. Keep the Spring Boot parent generated by Initializr and add these dependencies inside `<dependencies>`:
...
Replace `backend/shop-server/src/main/resources/application.yml` with:
...
Replace `backend/shop-server/src/main/resources/application-dev.yml` with:

```yaml
spring:
  datasource:
    url: jdbc:mysql://127.0.0.1:3306/hotpot_shop?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true&useSSL=false
    username: hotpot_shop
    password: hotpot_shop
...
logging:
  level:
    com.muybaby.shop: debug
```

- [ ] **Step 4: Add test profile config**

Create `backend/shop-server/src/test/resources/application-test.yml`:
...
- [ ] **Step 5: Run generated backend test**
...
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/common/api/ApiResponse.java`
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/common/api/PageResult.java`
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/health/HealthController.java`
- Create: `backend/shop-server/src/test/java/com/muybaby/shop/common/api/ApiResponseTest.java`
- Create: `backend/shop-server/src/test/java/com/muybaby/shop/health/HealthControllerTest.java`
...
```java
package com.muybaby.shop.common.api;
...
```java
package com.muybaby.shop.health;
...
import com.muybaby.shop.common.api.ApiResponse;
...
```bash
git add backend/shop-server/src/main/java/com/muybaby/shop/common/api backend/shop-server/src/main/java/com/muybaby/shop/health backend/shop-server/src/test/java/com/muybaby/shop/common/api backend/shop-server/src/test/java/com/muybaby/shop/health
...
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/common/error/ErrorCode.java`
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/common/error/BusinessException.java`
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/common/error/GlobalExceptionHandler.java`
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/security/SecurityConfig.java`
- Create: `backend/shop-server/src/test/java/com/muybaby/shop/common/error/GlobalExceptionHandlerTest.java`
- Create: `backend/shop-server/src/test/java/com/muybaby/shop/security/SecurityConfigTest.java`
...
```java
package com.muybaby.shop.common.error;
...
```java
package com.muybaby.shop.security;
...
```bash
git add backend/shop-server/src/main/java/com/muybaby/shop/common/error backend/shop-server/src/main/java/com/muybaby/shop/security backend/shop-server/src/test/java/com/muybaby/shop/common/error backend/shop-server/src/test/java/com/muybaby/shop/security
...
- Create: `backend/shop-server/src/main/java/com/muybaby/shop/common/web/RequestIdFilter.java`
- Create: `backend/shop-server/src/test/java/com/muybaby/shop/common/web/RequestIdFilterTest.java`
...
```java
package com.muybaby.shop.common.web;
...
```bash
git add backend/shop-server/src/main/resources/db/migration backend/shop-server/src/main/java/com/muybaby/shop/common/web backend/shop-server/src/test/java/com/muybaby/shop/common/web
