...
class AfterSaleReturnWorkflowTest extends PaymentTestSupport {
    ...
    void returnedQuantityMovesThroughShipmentInspectionRefundAndPartialRestock() throws Exception {
        ...
        SeedPaidOrder order = seedPaidOrder(
                user, 6980L, "SHIPPED", "return-refund-workflow-transaction");
        ...
        assertThat(jdbcClient.sql("""
                ...
                .query(String.class)
                .single()).isEqualTo("SHIPPED|PARTIALLY_REFUNDED|3490");
        assertThat(jdbcClient.sql("""
