...
public class AppCustomerServiceController {
    ...
    public ResponseEntity<InputStreamResource> image(
        ...
        return customerServiceService.imageForApp(principal, messageId, ifNoneMatch);
    }
    ...
    public ResponseEntity<InputStreamResource> thumbnail(
        ...
        return customerServiceService.thumbnailForApp(principal, messageId, ifNoneMatch);
    }
    ...
    public ApiResponse<ImageMessageResponse> imageAccess(
        ...
        return ApiResponse.success(customerServiceService.imageAccessForApp(principal, messageId));
    }
}
