    ...
    private HttpStatus statusFor(ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case AUTHENTICATION_TEMPORARILY_UNAVAILABLE,
                 PAYMENT_CONFIG_VERIFICATION_UNAVAILABLE,
                 WECHAT_PLATFORM_CONFIG_UNAVAILABLE,
                 WECHAT_PLATFORM_VERIFICATION_UNAVAILABLE,
                 ...
                 ACCOUNT_CANCELLATION_NOTICE_UNAVAILABLE,
                 STORAGE_CUSTOM_DOMAIN_VERIFICATION_UNAVAILABLE,
                 STORAGE_CONFIG_VERIFICATION_UNAVAILABLE,
