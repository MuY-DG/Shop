...
public enum AdminAfterSaleStatusGroup {
    ...
    PENDING_REVIEW(List.of(
            AfterSaleStatus.REQUESTED.name(), AfterSaleStatus.WAITING_INSPECTION.name())),
    REFUNDING(List.of(
            AfterSaleStatus.APPROVED.name(), AfterSaleStatus.WAITING_RETURN.name(),
            AfterSaleStatus.RETURNING.name(), AfterSaleStatus.REFUNDING.name())),
    REFUNDED(List.of(AfterSaleStatus.REFUNDED.name())),
    REJECTED(List.of(AfterSaleStatus.REJECTED.name(), AfterSaleStatus.RETURN_REJECTED.name())),
